  ...
  return (
    <div className="flex flex-col gap-5 pt-5">
      ...
      <p className="roboto-font max-w-xl">
        Упростите процесс доставки и сделайте его
        более эффективным с помощью наших грузовых
        услуг. От начала до конца мы позаботимся
        обо всем, чтобы обеспечить безопасную
